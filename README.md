...
Lo que nos va a permitir esto: <b>Poder limpiar la consola(CTRL + L), ver el historial de comandos mediante las teclas "flechas direccionales" y tratar con la edición de ficheros mediante editores sin que se corrompan.</b>
